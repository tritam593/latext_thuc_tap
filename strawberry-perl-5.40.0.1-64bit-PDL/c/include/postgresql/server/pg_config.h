...
#define CONFIGURE_ARGS " '--host=x86_64-w64-mingw32' '--build=x86_64-w64-mingw32' '--prefix=/z/extlib/_5040__' '--with-zlib' '--with-ldap' '--with-openssl' '--without-icu' '--with-includes=/z/extlib/_5040__/include' '--with-libraries=/z/extlib/_5040__/lib' 'build_alias=x86_64-w64-mingw32' 'host_alias=x86_64-w64-mingw32' 'PKG_CONFIG=/bin/pkg-config' 'PKG_CONFIG_PATH=/z/extlib/_5040__/lib/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 16.2 on x86_64-w64-mingw32, compiled by x86_64-w64-mingw32-gcc.exe (MinGW-W64 x86_64-ucrt-posix-seh, built by Brecht Sanders, r8) 13.2.0, 64-bit"
